...
const Holiday = () => {
  return (
    <Container>
      {/* Text section */}
      <div className="text-center w-1/2 mx-auto mt-32">
        <h3 className="font-medium text-2xl uppercase text-[#070211]">What is Funtional</h3>
        <h2 className="font-bold font2 text-6xl text-[#ff0000] mt-8">
      ...
      {/* Image Section */}
      <div className="grid grid-cols-6 items-center mt-24">
